  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      <header className="rounded-3xl border border-border/60 bg-white/90 p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-relaxed text-[color:var(--brand-ink-muted)] sm:text-base">
          将研ログは研究会の活動記録を効率的に行うための記録ツールです。
        </p>
      </header>

      <section className="rounded-2xl border border-border/60 bg-white/90 p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-[color:var(--brand-ink)]">
          使い方のポイント
        </h2>
        <ul className="mt-4 space-y-3 text-sm text-[color:var(--brand-ink-muted)]">
