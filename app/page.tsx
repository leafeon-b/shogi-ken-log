  ...
  return (
    <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-10">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-32 right-4 h-72 w-72 rounded-full bg-[radial-gradient(circle_at_top,_var(--brand-gold)_0,_transparent_68%)] blur-3xl motion-safe:animate-[glow_9s_ease-in-out_infinite]" />
        <div className="absolute -bottom-40 -left-16 h-80 w-80 rounded-full bg-[radial-gradient(circle_at_top,_var(--brand-sky)_0,_transparent_65%)] blur-3xl motion-safe:animate-[glow_12s_ease-in-out_infinite]" />
        <div className="absolute inset-0 opacity-25 [background-image:linear-gradient(90deg,_rgba(0,0,0,0.04)_1px,_transparent_1px),linear-gradient(rgba(0,0,0,0.04)_1px,_transparent_1px)] [background-size:32px_32px]" />
      </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-[color:var(--brand-gold)]/20 px-3 py-1 text-xs text-[color:var(--brand-ink)]">
              2026/03/12
            </span>
          </div>
          <p className="mt-3 text-2xl font-semibold text-[color:var(--brand-ink)]">
            第42回 週末研究会
          </p>
        ...
        >
          <Button className="w-full bg-[color:var(--brand-moss)] text-white hover:bg-[color:var(--brand-moss)]/90">
            <CirclePlus />
            研究会を新規作成
          </Button>
        </div>
